...
from .views import EstadoUpdate, CidadeUpdate, FornecedorUpdate, PessoaUpdate, CategoriaUpdate, ProdutoUpdate, VendaUpdate
from .views import EstadoDelete, CidadeDelete, FornecedorDelete, PessoaDelete, CategoriaDelete, ProdutoDelete, VendaDelete
