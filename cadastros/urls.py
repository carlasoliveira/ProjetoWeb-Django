...
from .views import EstadoList, CidadeList, FornecedorList, PessoaList, CategoriaList, ProdutoList, VendaList, ItensVendaList
...
urlpatterns = [
   ...
   path('editar/carrinho/<int:pk>/', ItensVendaUpdate.as_view(), name="editar-carrinho"),
   ...
   path('excluir/carrinho/<int:pk>/', ItensVendaDelete.as_view(), name="deletar-carrinho"),
   ...
   path('carrinho/', ItensVendaList.as_view(), name="listar-carrinho"),
]
